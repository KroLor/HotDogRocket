...
typedef struct {
    ...
    uint8_t config;
    uint8_t ctrl_hum;
} BMx280_sensor_settings_t;

extern BMx280_sensor_settings_t BMx280_sensor_settings;
extern BMx280_calibration_data calibration_data;
